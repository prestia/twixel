...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Anthony Prestia", "twixel-sample", "com.anthonyprestia.twixel-sample", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "twixel sample", null, { width: 0, height: 0 });
