...
class HXCPP_CLASS_ATTRIBUTES  FlxSpriteUtil_obj : public hx::Object{
	...
	public:
		...
		static ::flixel::FlxSprite fadeIn( ::flixel::FlxSprite sprite,Float Duration,Dynamic ResetAlpha,Dynamic OnComplete);
		static Dynamic fadeIn_dyn();

		static ::flixel::FlxSprite fadeOut( ::flixel::FlxSprite sprite,Float Duration,Dynamic FadeToBlack,Dynamic OnComplete);
