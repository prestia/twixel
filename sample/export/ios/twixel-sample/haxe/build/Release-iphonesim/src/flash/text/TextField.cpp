...
{
	HX_STACK_LINE(42)
	super::__construct(::flash::text::TextField_obj::lime_text_field_create(),HX_CSTRING("TextField"));
	HX_STACK_LINE(44)
...
::flash::text::TextFieldType TextField_obj::get_type( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(148)
	return (  ((::flash::text::TextField_obj::lime_text_field_get_type(this->__handle))) ? ::flash::text::TextFieldType(::flash::text::TextFieldType_obj::INPUT) : ::flash::text::TextFieldType(::flash::text::TextFieldType_obj::DYNAMIC) );
}
...
::String TextField_obj::get_htmlText( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(127)
	return ::StringTools_obj::replace(::flash::text::TextField_obj::lime_text_field_get_html_text(this->__handle),HX_CSTRING("\n"),HX_CSTRING("<br/>"));
}
...
::flash::text::TextFieldAutoSize TextField_obj::set_autoSize( ::flash::text::TextFieldAutoSize value){
	...
	HX_STACK_ARG(value,"value");
	HX_STACK_LINE(111)
	::flash::text::TextField_obj::lime_text_field_set_auto_size(this->__handle,value->__Index());
	HX_STACK_LINE(111)
	return value;
}
...
::flash::text::TextFieldAutoSize TextField_obj::get_autoSize( ){
	...
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
	return ::Type_obj::createEnumIndex(hx::ClassOf< ::flash::text::TextFieldAutoSize >(),::flash::text::TextField_obj::lime_text_field_get_auto_size(this->__handle),null());
}
...
Void TextField_obj::appendText( ::String text){
{
		...
		HX_STACK_LINE(50)
		::flash::text::TextField_obj::lime_text_field_set_text(this->__handle,(::flash::text::TextField_obj::lime_text_field_get_text(this->__handle) + text));
	}
return null();
}
