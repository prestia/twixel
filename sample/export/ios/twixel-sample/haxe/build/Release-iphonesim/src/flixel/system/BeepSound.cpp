...
{
HX_STACK_PUSH("BeepSound::new","openfl/Assets.hx",1474);
...
void BeepSound_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(BeepSound);
	super::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}

void BeepSound_obj::__Visit(HX_VISIT_PARAMS)
{
