...
{
		HX_STACK_PUSH("FlxAssets::init","flixel/system/FlxAssets.hx",33);
		HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("FlxAssets::drawLogo","flixel/system/FlxAssets.hx",42);
...
::flash::display::BitmapData FlxAssets_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("FlxAssets::getBitmapData","flixel/system/FlxAssets.hx",98);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(98)
...
{
		HX_STACK_PUSH("FlxAssets::cacheSounds","flixel/system/FlxAssets.hx",109);
	}
return null();
}
