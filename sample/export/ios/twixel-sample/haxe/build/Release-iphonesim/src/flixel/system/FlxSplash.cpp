...
{
HX_STACK_PUSH("FlxSplash::new","flixel/system/FlxSplash.hx",21);
{
	HX_STACK_LINE(32)
	this->_curPart = (int)0;
	HX_STACK_LINE(39)
...
{
		HX_STACK_PUSH("FlxSplash::onComplete","flixel/system/FlxSplash.hx",197);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("FlxSplash::drawLightBlue","flixel/system/FlxSplash.hx",185);
		HX_STACK_THIS(this);
		HX_STACK_LINE(186)
...
{
		HX_STACK_PUSH("FlxSplash::drawBlue","flixel/system/FlxSplash.hx",173);
		HX_STACK_THIS(this);
		HX_STACK_LINE(174)
...
{
		HX_STACK_PUSH("FlxSplash::drawRed","flixel/system/FlxSplash.hx",161);
		HX_STACK_THIS(this);
		HX_STACK_LINE(162)
...
{
		HX_STACK_PUSH("FlxSplash::drawYellow","flixel/system/FlxSplash.hx",149);
		HX_STACK_THIS(this);
		HX_STACK_LINE(150)
...
{
		HX_STACK_PUSH("FlxSplash::drawGreen","flixel/system/FlxSplash.hx",134);
		HX_STACK_THIS(this);
		HX_STACK_LINE(135)
...
{
		HX_STACK_PUSH("FlxSplash::timerCallback","flixel/system/FlxSplash.hx",119);
		HX_STACK_THIS(this);
		...
		if (((this->_curPart == (int)5))){
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_PUSH("*::closure","flixel/system/FlxSplash.hx",128);
					{
			...
			HX_STACK_LINE(128)
			::flixel::tweens::FlxTween_obj::multiVar(this->_sprite,_Function_2_1::Block(),3.0,_Function_2_2::Block(this));
			struct _Function_2_3{
				inline static Dynamic Block( ){
					HX_STACK_PUSH("*::closure","flixel/system/FlxSplash.hx",129);
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("alpha") , (int)0,false);
						return __result;
			...
			HX_STACK_LINE(129)
			::flixel::tweens::FlxTween_obj::multiVar(this->_text,_Function_2_3::Block(),3.0,_Function_2_4::Block());
		}
	}
return null();
}
...
{
		HX_STACK_PUSH("FlxSplash::create","flixel/system/FlxSplash.hx",71);
		HX_STACK_THIS(this);
		HX_STACK_LINE(72)
		...
		HX_STACK_LINE(114)
		::flixel::FlxG_obj::sound->load(hx::ClassOf< ::flixel::system::FlixelSound >(),null(),null(),null(),null(),null(),null())->play(null());
	}
return null();
}
...
{
		HX_STACK_PUSH("FlxSplash::onResize","flixel/system/FlxSplash.hx",56);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(64)
		this->_text->set_y((this->_sprite->get_y() + ((int)80 * ::flixel::FlxG_obj::game->get_scaleY())));
		HX_STACK_LINE(66)
...
{
		HX_STACK_PUSH("FlxSplash::destroy","flixel/system/FlxSplash.hx",44);
		HX_STACK_THIS(this);
		HX_STACK_LINE(45)
