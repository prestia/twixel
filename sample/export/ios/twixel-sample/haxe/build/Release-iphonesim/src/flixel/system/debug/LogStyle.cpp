...
Void LogStyle_obj::__construct(::String __o_Prefix,::String __o_Color,hx::Null< int >  __o_Size,hx::Null< bool >  __o_Bold,hx::Null< bool >  __o_Italic,hx::Null< bool >  __o_Underlined,::flash::media::Sound ErrorSound,hx::Null< bool >  __o_OpenConsole,Dynamic CallbackFunction)
{
HX_STACK_PUSH("LogStyle::new","flixel/system/debug/LogStyle.hx",56);
...
hx::ObjectPtr< LogStyle_obj > LogStyle_obj::__new(::String __o_Prefix,::String __o_Color,hx::Null< int >  __o_Size,hx::Null< bool >  __o_Bold,hx::Null< bool >  __o_Italic,hx::Null< bool >  __o_Underlined,::flash::media::Sound ErrorSound,hx::Null< bool >  __o_OpenConsole,Dynamic CallbackFunction)
...
Dynamic LogStyle_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"errorSound") ) { errorSound=inValue.Cast< ::flash::media::Sound >(); return inValue; }
...
void LogStyle_obj::__boot()
{
	...
	WARNING= ::flixel::system::debug::LogStyle_obj::__new(HX_CSTRING("[WARNING] "),HX_CSTRING("FFFF00"),(int)12,true,false,false,::flixel::system::BeepSound_obj::__new(null(),null(),null()),true,null());
	ERROR= ::flixel::system::debug::LogStyle_obj::__new(HX_CSTRING("[ERROR] "),HX_CSTRING("FF0000"),(int)12,true,false,false,::flixel::system::BeepSound_obj::__new(null(),null(),null()),true,null());
