...
{
HX_STACK_PUSH("LogFrontEnd::new","flixel/system/frontEnds/LogFrontEnd.hx",8);
{
	HX_STACK_LINE(14)
...
{
		HX_STACK_PUSH("LogFrontEnd::processTraceData","flixel/system/frontEnds/LogFrontEnd.hx",123);
		HX_STACK_THIS(this);
...
bool LogFrontEnd_obj::set_redirectTraces( bool Redirect){
	HX_STACK_PUSH("LogFrontEnd::set_redirectTraces","flixel/system/frontEnds/LogFrontEnd.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Redirect,"Redirect");
	HX_STACK_LINE(112)
	::haxe::Log_obj::trace = (  ((Redirect)) ? Dynamic(this->processTraceData_dyn()) : Dynamic(this->_standardTraceFunction) );
	HX_STACK_LINE(113)
...
{
		HX_STACK_PUSH("LogFrontEnd::clear","flixel/system/frontEnds/LogFrontEnd.hx",98);
		HX_STACK_THIS(this);
	}
return null();
}
...
bool FireOnce = __o_FireOnce.Default(false);
	HX_STACK_PUSH("LogFrontEnd::advanced","flixel/system/frontEnds/LogFrontEnd.hx",54);
	HX_STACK_THIS(this);
	HX_STACK_ARG(Data,"Data");
...
{
		HX_STACK_PUSH("LogFrontEnd::notice","flixel/system/frontEnds/LogFrontEnd.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Data,"Data");
	}
return null();
...
{
		HX_STACK_PUSH("LogFrontEnd::error","flixel/system/frontEnds/LogFrontEnd.hx",33);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Data,"Data");
	}
return null();
...
{
		HX_STACK_PUSH("LogFrontEnd::warn","flixel/system/frontEnds/LogFrontEnd.hx",26);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Data,"Data");
	}
return null();
...
{
		HX_STACK_PUSH("LogFrontEnd::add","flixel/system/frontEnds/LogFrontEnd.hx",19);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Data,"Data");
	}
return null();
