...
{
HX_STACK_PUSH("RectPointTileID::new","flixel/system/layer/TileSheetExt.hx",118);
{
	HX_STACK_LINE(119)
	this->id = id;
	HX_STACK_LINE(120)
...
{
		HX_STACK_PUSH("RectPointTileID::destroy","flixel/system/layer/TileSheetExt.hx",125);
		HX_STACK_THIS(this);
		HX_STACK_LINE(126)
		this->rect = null();
		HX_STACK_LINE(127)
