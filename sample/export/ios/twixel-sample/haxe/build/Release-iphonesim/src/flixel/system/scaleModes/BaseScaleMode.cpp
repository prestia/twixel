...
{
HX_STACK_PUSH("BaseScaleMode::new","flixel/system/scaleModes/BaseScaleMode.hx",17);
{
	HX_STACK_LINE(18)
...
{
		HX_STACK_PUSH("BaseScaleMode::updateGamePosition","flixel/system/scaleModes/BaseScaleMode.hx",70);
		HX_STACK_THIS(this);
		HX_STACK_LINE(71)
...
{
		HX_STACK_PUSH("BaseScaleMode::updateGameScale","flixel/system/scaleModes/BaseScaleMode.hx",64);
		HX_STACK_THIS(this);
		HX_STACK_LINE(65)
...
{
		HX_STACK_PUSH("BaseScaleMode::updateScaleOffset","flixel/system/scaleModes/BaseScaleMode.hx",44);
		HX_STACK_THIS(this);
		HX_STACK_LINE(45)
		...
		if (((::flixel::FlxG_obj::camera != null()))){
			struct _Function_2_1{
				inline static ::flixel::util::FlxPoint Block( ){
					HX_STACK_PUSH("*::closure","flixel/system/scaleModes/BaseScaleMode.hx",52);
					{
						HX_STACK_LINE(52)
			...
			struct _Function_2_2{
				inline static ::flixel::util::FlxPoint Block( ){
					HX_STACK_PUSH("*::closure","flixel/system/scaleModes/BaseScaleMode.hx",53);
					{
						HX_STACK_LINE(53)
						::flixel::FlxCamera _this = ::flixel::FlxG_obj::camera;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(53)
...
{
		HX_STACK_PUSH("BaseScaleMode::updateDeviceSize","flixel/system/scaleModes/BaseScaleMode.hx",39);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BaseScaleMode::updateGameSize","flixel/system/scaleModes/BaseScaleMode.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Width,"Width");
		HX_STACK_ARG(Height,"Height");
		HX_STACK_LINE(34)
...
{
		HX_STACK_PUSH("BaseScaleMode::onMeasure","flixel/system/scaleModes/BaseScaleMode.hx",25);
		HX_STACK_THIS(this);
		HX_STACK_ARG(Width,"Width");
		HX_STACK_ARG(Height,"Height");
		HX_STACK_LINE(26)
