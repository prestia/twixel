...
{
HX_STACK_PUSH("GraphicAuto::new","openfl/Assets.hx",1270);
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1304)
	::flash::utils::ByteArray byteArray = ::flash::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAuto_obj::resourceName));		HX_STACK_VAR(byteArray,"byteArray");
	HX_STACK_LINE(1305)
...
void GraphicAuto_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(GraphicAuto);
	super::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}

void GraphicAuto_obj::__Visit(HX_VISIT_PARAMS)
{
