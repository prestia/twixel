...
{
HX_STACK_PUSH("LinearPath::new","flixel/tweens/motion/LinearPath.hx",35);
...
{
		HX_STACK_PUSH("LinearPath::update","flixel/tweens/motion/LinearPath.hx",112);
		HX_STACK_THIS(this);
		HX_STACK_LINE(113)
		this->super::update();
		HX_STACK_LINE(114)
...
int index = __o_index.Default(0);
	HX_STACK_PUSH("LinearPath::getPoint","flixel/tweens/motion/LinearPath.hx",96);
	HX_STACK_THIS(this);
...
Float y = __o_y.Default(0);
	HX_STACK_PUSH("LinearPath::addPoint","flixel/tweens/motion/LinearPath.hx",85);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
{
...
bool UseDuration = __o_UseDuration.Default(true);
	HX_STACK_PUSH("LinearPath::setMotion","flixel/tweens/motion/LinearPath.hx",65);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("LinearPath::destroy","flixel/tweens/motion/LinearPath.hx",47);
		HX_STACK_THIS(this);
		HX_STACK_LINE(48)
		this->super::destroy();
		HX_STACK_LINE(49)
