...
{
HX_STACK_PUSH("GraphicButton::new","openfl/Assets.hx",1270);
...
void GraphicButton_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(GraphicButton);
	super::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}

void GraphicButton_obj::__Visit(HX_VISIT_PARAMS)
{
