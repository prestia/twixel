...
Float frequency = __o_frequency.Default(1.0);
	HX_STACK_PUSH("FlxAngle::sinCosGenerator","flixel/util/FlxAngle.hx",181);
...
int FlxAngle_obj::wrapAngle( Float angle){
	HX_STACK_PUSH("FlxAngle::wrapAngle","flixel/util/FlxAngle.hx",208);
	HX_STACK_ARG(angle,"angle");
	HX_STACK_LINE(209)
...
int FlxAngle_obj::angleLimit( int angle,int min,int max){
	HX_STACK_PUSH("FlxAngle::angleLimit","flixel/util/FlxAngle.hx",233);
	HX_STACK_ARG(angle,"angle");
...
Float FlxAngle_obj::asDegrees( Float radians){
	HX_STACK_PUSH("FlxAngle::asDegrees","flixel/util/FlxAngle.hx",256);
...
Float FlxAngle_obj::asRadians( Float degrees){
	HX_STACK_PUSH("FlxAngle::asRadians","flixel/util/FlxAngle.hx",268);
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_PUSH("FlxAngle::angleBetween","flixel/util/FlxAngle.hx",282);
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_PUSH("FlxAngle::angleBetweenPoint","flixel/util/FlxAngle.hx",302);
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_PUSH("FlxAngle::angleBetweenMouse","flixel/util/FlxAngle.hx",322);
...
bool AsDegrees = __o_AsDegrees.Default(false);
	HX_STACK_PUSH("FlxAngle::angleBetweenTouch","flixel/util/FlxAngle.hx",350);
	HX_STACK_ARG(Object,"Object");
...
::flixel::util::FlxPoint FlxAngle_obj::getCartesianCoords( Float Radius,Float Angle,::flixel::util::FlxPoint point){
	HX_STACK_PUSH("FlxAngle::getCartesianCoords","flixel/util/FlxAngle.hx",373);
...
::flixel::util::FlxPoint FlxAngle_obj::getPolarCoords( Float X,Float Y,::flixel::util::FlxPoint point){
	HX_STACK_PUSH("FlxAngle::getPolarCoords","flixel/util/FlxAngle.hx",394);
	HX_STACK_ARG(X,"X");
	HX_STACK_ARG(Y,"Y");
	HX_STACK_ARG(point,"point");
	HX_STACK_LINE(395)
