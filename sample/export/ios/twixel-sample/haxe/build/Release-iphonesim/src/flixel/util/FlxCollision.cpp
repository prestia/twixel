...
int AlphaTolerance = __o_AlphaTolerance.Default(1);
	HX_STACK_PUSH("FlxCollision::pixelPerfectCheck","flixel/util/FlxCollision.hx",46);
	...
	HX_STACK_ARG(Camera,"Camera");
{
		...
		HX_STACK_LINE(50)
		Camera = (  (((Camera != null()))) ? ::flixel::FlxCamera(Camera) : ::flixel::FlxCamera(::flixel::FlxG_obj::camera) );
		HX_STACK_LINE(52)
		...
		HX_STACK_LINE(90)
		if (((bool((bool(intersect->isEmpty()) || bool((intersect->width < (int)1)))) || bool((intersect->height < (int)1))))){
			HX_STACK_LINE(91)
			return false;
		}
		HX_STACK_LINE(96)
		...
		if ((considerRotation)){
			...
			HX_STACK_LINE(122)
			::flixel::util::FlxCollision_obj::testMatrix->rotate((Contact->angle * ::flixel::util::FlxAngle_obj::TO_RAD));
			HX_STACK_LINE(125)
			...
			HX_STACK_LINE(128)
			::flash::display::BitmapData testA2 = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,(int)0,false);		HX_STACK_VAR(testA2,"testA2");
			HX_STACK_LINE(131)
			...
			HX_STACK_LINE(137)
			::flixel::util::FlxCollision_obj::testMatrix->rotate((Target->angle * ::flixel::util::FlxAngle_obj::TO_RAD));
			HX_STACK_LINE(138)
			...
			HX_STACK_LINE(140)
			::flash::display::BitmapData testB2 = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,(int)0,false);		HX_STACK_VAR(testB2,"testB2");
			HX_STACK_LINE(141)
...
int AlphaTolerance = __o_AlphaTolerance.Default(1);
	HX_STACK_PUSH("FlxCollision::pixelPerfectPointCheck","flixel/util/FlxCollision.hx",213);
	...
	HX_STACK_ARG(AlphaTolerance,"AlphaTolerance");
{
		...
		struct _Function_1_1{
			inline static ::flash::display::BitmapData Block( ::flixel::FlxSprite &Target){
				HX_STACK_PUSH("*::closure","flixel/util/FlxCollision.hx",224);
				{
					HX_STACK_LINE(224)
...
bool AdjustWorldBounds = __o_AdjustWorldBounds.Default(false);
	HX_STACK_PUSH("FlxCollision::createCameraWall","flixel/util/FlxCollision.hx",255);
	HX_STACK_ARG(Camera,"Camera");
