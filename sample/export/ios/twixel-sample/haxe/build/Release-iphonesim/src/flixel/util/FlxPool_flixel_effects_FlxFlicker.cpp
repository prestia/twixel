...
{
HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::new","flixel/util/FlxPool.hx",13);
{
	HX_STACK_LINE(13)
...
int FlxPool_flixel_effects_FlxFlicker_obj::get_length( ){
	HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::get_length","flixel/util/FlxPool.hx",51);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
...
Array< ::Dynamic > FlxPool_flixel_effects_FlxFlicker_obj::clear( ){
	HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::clear","flixel/util/FlxPool.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_LINE(45)
...
{
		HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::putUnsafe","flixel/util/FlxPool.hx",35);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::put","flixel/util/FlxPool.hx",25);
		HX_STACK_THIS(this);
		HX_STACK_ARG(obj,"obj");
		HX_STACK_LINE(25)
...
::flixel::effects::FlxFlicker FlxPool_flixel_effects_FlxFlicker_obj::get( ){
	HX_STACK_PUSH("FlxPool_flixel_effects_FlxFlicker::get","flixel/util/FlxPool.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_LINE(19)
