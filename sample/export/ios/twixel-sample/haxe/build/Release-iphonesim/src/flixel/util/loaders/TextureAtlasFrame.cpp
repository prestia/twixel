...
{
HX_STACK_PUSH("TextureAtlasFrame::new","flixel/util/loaders/TextureAtlasFrame.hx",7);
{
	HX_STACK_LINE(15)
	this->offset = null();
	HX_STACK_LINE(14)
...
{
		HX_STACK_PUSH("TextureAtlasFrame::destroy","flixel/util/loaders/TextureAtlasFrame.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_LINE(21)
		this->name = null();
		HX_STACK_LINE(22)
