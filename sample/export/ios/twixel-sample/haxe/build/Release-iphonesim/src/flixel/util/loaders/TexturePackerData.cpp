...
{
HX_STACK_PUSH("TexturePackerData::new","flixel/util/loaders/TexturePackerData.hx",26);
{
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("TexturePackerData::destroy","flixel/util/loaders/TexturePackerData.hx",77);
		HX_STACK_THIS(this);
		HX_STACK_LINE(78)
		{
			HX_STACK_LINE(78)
			...
			while(((_g < _g1->length))){
				...
				++(_g);
				HX_STACK_LINE(80)
				frame = ::flixel::FlxG_obj::safeDestroy(frame);
			}
		}
		HX_STACK_LINE(82)
		this->frames = null();
...
{
		HX_STACK_PUSH("TexturePackerData::parseData","flixel/util/loaders/TexturePackerData.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_LINE(42)
