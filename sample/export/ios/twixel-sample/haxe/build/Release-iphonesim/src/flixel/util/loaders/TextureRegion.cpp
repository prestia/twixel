...
{
HX_STACK_PUSH("TextureRegion::new","flixel/util/loaders/TextureRegion.hx",12);
...
{
		HX_STACK_PUSH("TextureRegion::destroy","flixel/util/loaders/TextureRegion.hx",27);
		HX_STACK_THIS(this);
		HX_STACK_LINE(28)
		this->data = null();
		HX_STACK_LINE(29)
...
::flixel::util::loaders::TextureRegion TextureRegion_obj::clone( ){
	HX_STACK_PUSH("TextureRegion::clone","flixel/util/loaders/TextureRegion.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
